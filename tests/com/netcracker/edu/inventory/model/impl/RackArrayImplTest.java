...
public class RackArrayImplTest {
    ...
    @Test
    public void constructor_size1() throws Exception {
        int expSize = 1;
    ...
    @Test
    public void constructor_size3() throws Exception {
        int expSize = 3;
    ...
    public void getDevAtSlotIndexOutOfBounds() throws Exception {
        ...
        for (int i = 0; i < racks.length; i++) {
            for (int j = 0; j < allIndexes[i].length; j++) {
                Device result = racks[i].getDevAtSlot(allIndexes[i][j]);
                assertNull(result);
            }
        }
    ...
    public void insertDevToSlot() throws Exception {
        ...
        boolean result7 = rackPartlyFilled.insertDevToSlot(null, 4); //filled
        boolean result8 = rackPartlyFilled.insertDevToSlot(null, 5); //not filled
        boolean result9 = rackPartlyFilled.insertDevToSlot(batteryBadIn, 6); //filled
        boolean result10 = rackPartlyFilled.insertDevToSlot(batteryBadIn, 7); //not filled
    ...
    public void insertDevToSlotIndexOutOfBounds() throws Exception {
        ...
        for (int i = 0; i < racks.length; i++) {
            for (int j = 0; j < allIndexes[i].length; j++) {
                boolean result = racks[i].insertDevToSlot(battery, allIndexes[i][j]);
                assertFalse(result);
            }
        }
    ...
    public void removeDevFromSlotIndexOutOfBounds() throws Exception {
        ...
        for (int i = 0; i < racks.length; i++) {
            for (int j = 0; j < allIndexes[i].length; j++) {
                Device result = racks[i].removeDevFromSlot(allIndexes[i][j]);
                assertNull(result);
            }
        }
